...
namespace NTNL.NTNL_Config
{
    class DBConstants
    {
      ...
      public  const String DB_CONNECTION = "Data Source =C:/sqlite3"+ DBConstants.DB_NAME + ".sqlite3";
      public  const String CREATE_TABLE_ACCOUNT = "CREATE TABLE ACCOUNT(ID INTEGER NOT NULL , TwitterID TEXT NOT NULL, CK TEXT NOT NULL , CS TEXT NOT NULL , AT TEXT NOT NULL , ATS TEXT NOT NULL ,  PRIMARY KEY(ID , TwitterID ))";
